    ...
    <div>
      ...
      <div className="mt-5">
        ...
        <div className="mt-1.5 flex items-center gap-2">
          <div className="flex-1 flex rounded-lg border border-gray-200 overflow-hidden focus-within:ring-2 focus-within:ring-brand-500">
            <input
              type="number"
              min="0"
          ...
          <VoiceInputButton
            lang={lang}
            mode="number"
            onResult={(num) => setData({ ...data, estate_amount: num })}
          />
        </div>
      </div>
      ...
      <div className="mt-5">
        ...
        <div className="mt-1.5 flex items-center gap-2">
          ...
          <VoiceInputButton
            lang={lang}
            mode="text"
            onResult={(text) => setData({ ...data, title: text })}
          />
        </div>
      </div>
